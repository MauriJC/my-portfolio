...
async function seed() {
    ...
    const projectsData: Project[] = [
        ...
        {
            name: "Gym clients registration system ",
            description: 'Developed a client registration system for a local gym, utilizing Django and JavaScript to streamline document management and improve tracking of client payments.',
            demoLink: '',
